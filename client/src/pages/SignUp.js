    ...
    <AuthFormWrap>
      ...
      <AuthForm>
        <AuthFormBox>
          ...
          <AuthFormInput type='text' title='signUpName' id='signUpName' value={displayName} onChange={handleSignName}  required/>
        </AuthFormBox>
        <AuthFormBox>
          <AuthFormLabel htmlFor='signUpEmail'>Email</AuthFormLabel>
          <AuthFormInput type='text' title='signUpEmail' id='signUpEmail' value={email} onChange={handleSignEmail} required />
        </AuthFormBox>
        <AuthFormBox>
          <AuthFormLabel htmlFor='signUpPw'>Password</AuthFormLabel>
          <AuthFormInput type='password' title='signUpPw' id='signUpPw' value={password} onChange={handleSignPw} required/>
        </AuthFormBox>
        <AuthFormBox>
